...
public abstract class Animal extends Zoo {
    ...
    public boolean equals(Object o) {
        ...
        return getLifetime() == animal.getLifetime() && getId() == animal.getId() && Objects.equals(getColor(), animal.getColor()) && Objects.equals(getFoodtype(), animal.getFoodtype());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getColor(), getLifetime(), getFoodtype(), getId());
    }
}
